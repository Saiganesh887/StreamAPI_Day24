...
public class AddressBook {
    ...
    //for checking if contact already exists in contactList
    ...
    //for deleting the contact based on first name
    public void deleteContact() {
        ...
        for (Contacts contact : contactList) {
            if (contact.firstName.equals(name)) {
                ...
                System.out.println("Contact with first name "+ contact.firstName +" deleted");
            }
        }
    }

    //for editing the particular contact details
